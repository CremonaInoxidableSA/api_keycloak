...
async def eliminar_permiso(permiso_nombre: str):
    """
    ...
    try:
        ...
        permiso_url = f"{get_admin_base_url()}/roles/{permiso_nombre}"
        ...
        return {"detail": f"Permiso '{permiso_nombre}' eliminado exitosamente"}
